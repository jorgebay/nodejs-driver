 ...
 */
Connection.prototype.sendStream = function (request, options, callback, isFirst) {
  var self = this;
  var operation = new OperationState(request, options, callback, isFirst);
...
Connection.prototype.getInFlightAsFirst = function () {
  return this._inFlightAsFirst;
};
